...
for(def rowNum=2; rowNum<=3; rowNum++) {
	...
	WebUI.verifyElementText(findTestObject('loginInvalid/h3_Epic sadface Username and password do not match any user in this service'), 
		findTestData("user").getValue(3,rowNum))
